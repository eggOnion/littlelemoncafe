...
export const myFoodCard = {
  foodCardONE: {
    imgCredit:
      "https://goodyfoodies.blogspot.com/2021/01/spaghetti-aglio-olio-smoked-duck-recipe.html",
    description: `A delicious pasta dish with tender smoked duck, perfectly seasoned, offering 
    a rich, savory flavor that pairs beautifully`,
  },
  foodCardTWO: {
    imgCredit:
      "https://www.bbc.co.uk/food/recipes/perfect_steak_and_chips_14714",
    description: `Perfectly cooked steak with crispy duck fat fries, tender and 
    flavorful, an indulgent, savory meal, rich and satisfying!`,
  },
  foodCardTHREE: {
    imgCredit:
      "https://www.landsandflavors.com/vegan-meyer-lemon-creme-brulee/",
...
export const myReview = {
  reviewerONE: `This café is amazing! Warm ambiance, friendly staff, and great coffee. Their pastries are 
    fresh and delicious. Cozy seating and soft music make it perfect for work, meet-ups, or a relaxing break.`,
  reviewerTWO: `The steak was perfectly cooked, incredibly juicy, and seasoned to perfection. A must-try for 
  anyone craving a premium dining experience!`,
  reviewerTHREE: `The duck fat fries were golden, crispy, and rich in flavor, pairing flawlessly with the 
  tender, perfectly seasoned steak. A gourmet combo that's an absolute delight for the taste buds! The fries 
  had a buttery richness that stood out, while the steak was juicy and cooked to perfection. A must-try for food lovers!`,
...
export const myFooter = {
  ...
  Fusce rutrum lacus non malesuada facilisis.`,

  termAndConditionTHREE: `Mauris ligula velit, sagittis rhoncus laoreet eget, suscipit at risus. Cras ante arcu, aliquet 
  mollis nisi ac, imperdiet maximus risus. Duis lacinia vestibulum ornare. Pellentesque sit amet urna ac leo 
  sagittis lobortis. Curabitur sed fringilla leo. Nam luctus, lorem lobortis pretium cursus, mi mauris placerat 
